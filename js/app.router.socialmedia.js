                ...
                $stateProvider
                                    ...
                                    return $ocLazyLoad.load('chart.js').then(
                                        function() {
                                            return $ocLazyLoad.load([ 
                                                'js/controllers/soc-report-site.js',
                    ...
                    .state('app.soc-activity', {
                        ...
                        resolve: {
                            deps: ['uiLoad',
                                function(uiLoad) {
                                    return uiLoad.load(['vendor/font-awesome/css/font-awesome.css']);
                                }
                            ]
                        }
                    })
                    .state('app.mail', {
                        ...
                        resolve: {
                            deps: ['uiLoad',
                                function(uiLoad) {
                                    return uiLoad.load(['vendor/font-awesome/css/font-awesome.css', 'js/controllers/mail.js',
